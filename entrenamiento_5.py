...
model.add(Conv2D(kernel_size=10,strides=4,filters=32,padding="same",activation="relu",name="capa_1"))
model.add(MaxPool2D(pool_size=4,strides=4))

model.add(Conv2D(kernel_size=10,strides=4,filters=32,padding="same",activation="relu",name="capa_2"))
model.add(MaxPool2D(pool_size=4,strides=4))
